...
#ifndef VCOIN_QT_BITCOINUNITS_H
#define VCOIN_QT_BITCOINUNITS_H
...
/** VCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VCoinUnits(QObject *parent);

    /** VCoin units.
      @note Source: https://en.vcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef VCoinUnits::Unit BitcoinUnit;

#endif // VCOIN_QT_BITCOINUNITS_H
