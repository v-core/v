...
def initialize_chain(test_dir):
    ...
    4 wallets.
    vcoind and bitcoin-cli must be in search path.
    """
    ...
    if (not os.path.isdir(os.path.join("cache","node0"))
        ...
        for i in range(4):
            ...
            if os.getenv("PYTHON_DEBUG", ""):
                print "initialize_chain: vcoind started, calling bitcoin-cli -rpcwait getblockcount"
...
def start_node(i, dirname, extra_args=None, rpchost=None, timewait=None, binary=None):
    ...
    devnull = open(os.devnull, "w")
    if os.getenv("PYTHON_DEBUG", ""):
        print "start_node: vcoind started, calling bitcoin-cli -rpcwait getblockcount"
    subprocess.check_call([ os.getenv("VCOINCLI", "vcoin-cli"), "-datadir="+datadir] +
...
def wait_vcoinds():
    ...
    for vcoind in bitcoind_processes.values():
        vcoind.wait()
