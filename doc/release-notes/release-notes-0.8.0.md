VCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/vcoin/files/VCoin/bitcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the VCoin
...
New/changed settings (command-line or vcoin.conf file)
--------------------------------------------------------
