VCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/vcoin/files/VCoin/bitcoin-0.5.4/
...
http://gitorious.org/vcoin/bitcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Remove wxVCoin properly when installing Bitcoin-Qt over it. (Windows)
