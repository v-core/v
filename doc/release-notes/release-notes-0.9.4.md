VCoin Core version 0.9.4 is now available from:

  https://vcoin.org/bin/0.9.4/
...
this update is incompatible with the VCoin system and could lead to consensus
forks.

VCoin Core released binaries from https://vcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~vcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled VCoin Core

upgrade to VCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
